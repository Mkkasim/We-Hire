...
public class IntershipModel {
    ...
    private String courseName,workLocation,companyName,salary,
            ...
            compLongDes,compWeb,internRole,openingNum,roleResponsibility,formLink,appStatus,totalApplicants,compId;

    private String perk,perkCert,perkLetterOfR,perkFlexWh,perkDayWeek;
    private String skill;
    public IntershipModel() {
    }

    public IntershipModel(String perk) {
        this.perk = perk;
    }

//    public IntershipModel(String courseName, String workLocation, String companyName, String salary, String totalMonths, String companyImgUrl, String partFullTime, String key, String jobOrIntern, String compLongDes, String compWeb, String internRole, String openingNum) {
...
//    }
    ...
    public IntershipModel(String courseName, String workLocation, String companyName,
    ...
    public IntershipModel(String courseName, String workLocation, String companyName,
                          ...
                          String partFullTime, String key, String jobOrIntern, String roleResponsibility,
                          String compWeb, String openingNum,String skill,String compLongDes,String formLink,
                          String appStatus,String compId) {
        this.courseName = courseName;
        this.workLocation = workLocation;
        this.companyName = companyName;
        this.salary = salary;
