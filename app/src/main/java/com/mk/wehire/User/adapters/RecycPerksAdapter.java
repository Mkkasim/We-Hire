...
public class RecycPerksAdapter extends RecyclerView.Adapter<RecycPerksAdapter.InternViewHolder> {

    Context context;
    ArrayList<IntershipModel> list = new ArrayList<>();

    public RecycPerksAdapter(Context context, ArrayList<IntershipModel> list) {
    ...
    public void onBindViewHolder(@NonNull InternViewHolder holder, int position) {
        ...
        holder.perksSkills.setText(list.get(position).getPerk());
