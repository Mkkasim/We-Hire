...
public class RecycAllAdapter extends RecyclerView.Adapter<RecycAllAdapter.ApplicationViewHolder>{

    private static final String TAG = RecycAllAdapter.class.getSimpleName();
    ...
    public RecycAllAdapter(Context context, ArrayList<SignUpUser> signUpUsersList, OnItemClickListener onItemClickListener) {
