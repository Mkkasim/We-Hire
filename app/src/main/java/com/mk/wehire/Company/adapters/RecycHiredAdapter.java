...
public class RecycHiredAdapter extends RecyclerView.Adapter<RecycHiredAdapter.ApplicationViewHolder>{

    private static final String TAG = RecycHiredAdapter.class.getSimpleName();
    ...
    public RecycHiredAdapter(Context context, ArrayList<SignUpUser> signUpUsersList, OnItemClickListener onItemClickListener) {
        this.context = context;
        this.signUpUsersList = signUpUsersList;
        this.onItemClickListener = onItemClickListener;
    }

    public void filterList(ArrayList<SignUpUser> filterllist) {
        // below line is to add our filtered
        // list in our course array list.
        signUpUsersList = filterllist;
    ...
    public void onBindViewHolder(@NonNull ApplicationViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.hireBtn.setClickable(false);
        holder.hireBtn.setText("Hired");
        holder.hireBtn.setBackgroundColor(context.getResources().getColor(R.color.grey));
